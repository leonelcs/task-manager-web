...
export default function InviteMembersModal({
  ...
  const validateEmail = (email: string): boolean => {
    ...
    if (!isGoogleEmail) {
      setErrors({ email: 'Only Google emails (@gmail.com) are supported for ADHD-friendly authentication' });
      return false;
    }
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Hi! I'd love for you to join our ADHD support group..."
              rows={3}
          ...
          <div className="bg-gradient-to-r from-adhd-secondary-50 to-pebbles-50 rounded-lg p-4">
            <h4 className="font-medium text-gray-900 mb-2">
              Why join our ADHD support group?
            </h4>
            <ul className="text-sm text-gray-700 space-y-1">
              <li>• Body doubling and focus sessions</li>
              <li>• Shared accountability and encouragement</li>
